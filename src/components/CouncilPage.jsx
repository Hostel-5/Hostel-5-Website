...
export default function CouncilPage() {
  ...
  const sequence = [
    ...
    ["Cultural Councilor", "Cultural Nominee"],
    ["Sports Councilor", "Sports Nominee"],
    ["Technical Councilor"],
    ["Mess Councilor"],
    ["Maint Councilor"],
    ["System Admin"],
  ...
  return (
    <div className="text-white flex flex-col justify-center items-center m-auto gap-4 max-w-screen-md">
      {sequence.map((subSeq) => (
        <div className="flex flex-col sm:flex-row gap-4 justify-evenly sm:w-full">
          {subSeq.map((position) => {
            const person = data.find(
              (person) =>
                person.position.toLowerCase() == position.toLowerCase()
            );
            ...
            return (
              <div className="relative overflow-hidden min-w-64 flex flex-col justify-center items-center py-3 gap-2 after:content-[''] after:absolute after:-z-10 after:bg-slate-700 after:w-[150%]  after:h-[200%] after:rotate-45 hover:scale-105 transition-all">
                <div className="text-2xl font-bold tracking-tight my-1">
                  {person.position}
                </div>
                <img
                  src={
                ...
                {person.description && (
                  <div className="font-semibold">{person.description}</div>
                )}
                <div className="flex w-full items-center justify-evenly">
                  <a href={`tel:${person.phone}`} className="">
                    <svg
                      width="30px"
                      height="30px"
                      viewBox="0 0 24 24"
                  ...
                  <a href={`mailto:${person.email}`} className="">
                    <svg
                      fill="gray"
                      height="27px"
                      width="27px"
